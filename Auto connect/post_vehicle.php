...
if ($row1['count'] > 0) {
   ...
   if ($dbhh->query($sql) === TRUE) {
       ...
       $_SESSION['msg'] = $msg;
       if ($garageCount > 0) {
           $redirectUrl = "garage_list.php?id=" . urlencode($location_id);
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 offset-md-2 text-center">
                ...
                <?php if(isset($_SESSION['msg'])): ?>
                    <div class="succWrap" id="responseMessage"><strong>SUCCESS</strong>: <?php echo htmlentities($_SESSION['msg']); ?> </div>
...
<form  id="form" name="form" method="post" class="form-horizontal" enctype="multipart/form-data">
...
<!-- <div id="inspectionModal" class="modal fade" role="dialog" tabindex="-1"  aria-labelledby="inspectionModalLabel" aria-hidden="true">
     <div class="modal-dialog">
           <div class="modal-content">
               <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Inspection gateway</h4>
             </div>
           <div class="modal-body">
        <p>Do you want to inspect your car? Doing this will help in reaching a wider audience.</p>
      </div>
      <div class="modal-footer">
        <button type="button" id="postBtn" class="btn btn-light" data-dismiss="modal">No, just post</button>
        <button type="button" id="requestInspectionBtn" class="btn btn-primary">Yes, request for inspection</button>
      </div>
     </div>
        </div>
  </div> -->
...
<script>
        ...
        $('#saveChangesBtn').click(function(event) {
            ...
            if ($('#form').valid()) {
                ...
                // Form is not valid, prevent default action
            }
        });

        // Add your other event handlers here
        $('#requestInspectionBtn').click(function() {
            window.location.href = "car_listing_method.php";
