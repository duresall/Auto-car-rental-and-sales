...
// there the post will be on this form to be submited
$msg = ""; 
$error = ""; 
...
<section class="post_vehicle section-padding">
  <div class="container">
    <div  class="row">
      <div class="col-md-8">
        <h5>You can post you Vehicle using the form below</h5>
...
<!-- the form for subminting the cars -->
...
//englizegna becha endiyasaye lemarge
