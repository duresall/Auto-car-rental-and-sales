...
/* a section for uploading file or image */
/* Style for uploading file or image section */
.input-file {
...
.label-file {
    ...
    position: relative; /* Position relative for absolute positioning of file input */
}

.input-file {
    position: absolute; /* Position file input absolutely */
    top: 0;
    left: 0;
    opacity: 0; /* Make file input transparent */
...
.label-file i {
    ...
    /* Adjust the margin-right to match the space with the Telegram button */
    margin-right: 5px;
    margin-left: 5px;
    padding-top: 5px
}
...
/* the way the images and pdf will be displayed  */
.chat-box .incoming img,
.chat-box .outgoing img {
    ...
    margin-right: 8px; /* Optionally, add margin to separate images from text */
}
.chat-box .chat .pdf-icon {
    width: 50px; /* Adjust the width of the PDF icon as needed */
    height: 50px; /* Adjust the height of the PDF icon as needed */
    margin: 5px; /* Adjust the margin spacing as needed */
}
.chat-box .chat .pdf-link {
    color: blue; /* Set the color of the download link */
    text-decoration: underline; /* Underline the download link for emphasis */
    margin-left: 5px; /* Adjust the margin spacing as needed */
}
