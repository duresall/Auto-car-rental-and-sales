...
<!-- the form for search on the side bar -->
              ...
              <div class="form-group select">
                <select class="form-control">
                  <option>select price range</option>
                   <option value="Petrol">100000-500000</option>
                   <option value="Diesel">500000-1000000</option>
                   <option value="CNG">1000000-5000000</option>
                </select>
              </div>
      <!--END OF PRICE FILTER-->
...
<!-- this is for recently added cars-->
