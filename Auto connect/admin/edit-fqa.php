...
else
{
    ...
    if (isset($_POST["submit"])) {
        ...
        $sql = "UPDATE fqa SET question = ?, answer = ? WHERE id = $id";
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <form method="post"  class="form-horizontal">
                                         ...
                                         <?php
                                              $id=$_GET['id'];
                                              $query="SELECT * from fqa where id='$id'";
                                         ...
                                         ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea name="answer" id="answer" class="form-control"  value=""> <?php echo $row['answer']; ?></textarea>
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <div class="col-sm-8 col-sm-offset-4">
                                                <input type="submit" name="submit" class="btn btn-info" value="Update FAQ" />
                                                </div>
                                            </div>
                                        </form>
