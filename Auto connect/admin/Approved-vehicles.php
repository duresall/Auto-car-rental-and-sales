			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Approved Vehicles</h2>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                to suspend the post click suspended or to hold ont 
            </div>
            <div class="modal-footer">
                <button type="button" id="confirmButton" class="btn btn-primary" data-dismiss="modal" data-id="<?php echo $row['id']; ?>">Suspend</button>  
...
?>
  ...
  $(document).ready(function(){
      $('.change-status').click(function(){
          ...
          $('#confirmButton').attr('href', 'Approved-vehicles.php.php?pending=' + vehicleId);
      });
  });
</script>
