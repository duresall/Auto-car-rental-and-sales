...
error_reporting(0);
    ...
    if(isset($_GET['id'])) {
        $id = $_GET['id'];
        $sql2 = "DELETE FROM fqa WHERE id = '$id'";
													   ...
													   if ($result) {
														   ...
														   while ($row = $result->fetch_assoc()) {
															   ...
															   <tr>
																   ...
																   <td>
																	   <a href="edit-fqa.php?id=<?php echo $row['id']; ?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
																	   <a href="view-fqa.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Do you want to change the deleted this FQA?');"><i class="fa fa-close"></i></a>
																   </td>
															   </tr>
															   <?php
															   $cnt++;
