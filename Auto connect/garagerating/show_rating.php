...
<div class="container">		
	...
	$rating = new Rating();
	$garageDetails = $rating->getGarageList($_GET['garage_id']);
	foreach($garageDetails as $garage){
	...
	<div class="row">
		...
		<div><span class="average"><?php printf('%.1f', $average); ?> <small>/ 5</small></span> <span class="rating-reviews"><a href="show_rating.php?garagid=<?php echo $garage["garage_id"]; ?>">Rating & Reviews</a></span></div>
	...
	<div id="ratingDetails"> 		
		<div class="row">			
			...
			<div class="col-sm-3">
			<button type="button" id="rateGarage" class="btn btn-info">Rate this garage</button>
		...
		<div class="row">
			<div class="col-sm-7">
				...
				?>				
					<div class="row">
						<div class="col-sm-3">
							<img src="image/<?php echo $profilePic; ?>" class="img-rounded user-pic">
...
<script>
  ...
  // Show the rating section when the "Rate this garage" button is clicked
  $("#rateGarage").click(function () {
    $("#ratingDetails").hide();
    $("#ratingSection").show();
  });

  // Hide the rating section and show the rating details when the "Cancel" button is clicked
  $("#cancelReview").click(function () {
    $("#ratingSection").hide();
    $("#ratingDetails").show();
  });

  // Implement star rating select/deselect functionality
  ...
  // Save review using Ajax when the rating form is submitted
  $("#ratingForm").on("submit", function (event) {
	event.preventDefault(); // Prevent the default form submission behavior
	var formData = $(this).serialize(); // Serialize form data
	console.log(formData);
	// Send an AJAX request to the server to save the review
	$.ajax({
		url: "action.php",
		type: "POST",
		data: formData,
