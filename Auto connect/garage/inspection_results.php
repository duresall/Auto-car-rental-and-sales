...
//here check if the user schdule for the car is the seller or some one else 

$query = "SELECT userid FROM schedule WHERE vid = '$platenumber' AND garageid = '$garage_id'";
$result = $dbhh->query($query);
$row = $result->fetch_assoc();
$userid=$row['userid'];
$query1 = "SELECT userid FROM tblvehicles WHERE plate_number = '$platenumber'";
$results = $dbhh->query($query1);
...
$sql = "INSERT INTO inspection (
    vehicle_id, odometer, milage, transmition, exhustion,
    ...
    (SELECT id FROM tblvehicles WHERE plate_number = '$platenumber'),
...
<div class="form-group">
    ...
    <label class="col-sm-2 control-label">Tire Condition</label>
    <div class="col-sm-3">
