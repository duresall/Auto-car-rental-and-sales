...
$query="SELECT location_name from location where id=$location";
$result = $dbhh->query($query);
$row = $result->fetch_assoc();
$location= $row['location_name'];
print_r($location);
$sql1="SELECT id from tblvehicles where tblvehicles.location=$location and tblvehicles.FuleType='$fueltype' and tblvehicles.VehiclesBrand=$brand";
...
$sql = "SELECT tblvehicles.*, tblbrands.BrandName, tblbrands.id as bid  
        ...
        and tblvehicles.location='$location';
        AND tblvehicles.status = 1";
...
{  ?>
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <p class="list-price"> <?php echo $result['Price'];?> birr</p>
            <ul>
